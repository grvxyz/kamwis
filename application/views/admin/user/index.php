...
<main class="flex-1 p-4 md:p-6">
    ...
    <div class="bg-white rounded-lg shadow overflow-x-auto">
        <table class="min-w-full border border-gray-200 text-sm" id="userTable">
...
<!-- ================= MODAL ================= -->
<div id="modal"
class="fixed inset-0 hidden bg-black/50 flex items-center justify-center z-50 px-4">

<div id="modalBox"
class="bg-white w-full max-w-md rounded-xl p-6 shadow-lg
