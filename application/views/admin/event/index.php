...
<div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
    ...
    <div class="flex gap-3">
        <select onchange="filterEvent(this.value)"
...
<button onclick='editEvent(<?= json_encode($e) ?>)'
 class="px-3 py-1 bg-yellow-500 hover:bg-yellow-600
        text-white text-xs rounded">
Edit
</button>

<button onclick="hapusEvent(<?= $e->id_event ?>)"
...
<!-- ================= MODAL ================= -->
<div id="modal"
 class="fixed inset-0 hidden bg-black/50 z-50
...
<input name="nama_event" id="nama_event"
