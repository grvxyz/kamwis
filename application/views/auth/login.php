...
<body class="min-h-screen flex items-center justify-center animated-bg px-4 relative overflow-hidden">
    ...
    <div class="relative w-full max-w-md bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-10">
        ...
        <div class="flex flex-col items-center mb-6">
            <img src="<?= base_url('uploads/logo/logo kamwis.png'); ?>" class="w-16 h-16 object-contain mb-3">
        ...
        <form action="<?= site_url('auth/login_process') ?>" method="post" class="space-y-4">
            ...
            <div>
                ...
                <input type="email" name="email" required placeholder="contoh@email.com" class="w-full mt-1 px-4 py-3 rounded-xl border border-gray-300
                          bg-white/80 focus:ring-2 focus:ring-blue-500 focus:outline-none">
            </div>
            <div>
                <label class="text-sm font-medium text-gray-700">Password</label>
                <div class="relative mt-1">
                    <input type="password" id="password" name="password" required placeholder="Masukkan password" class="w-full px-4 py-3 pr-12 rounded-xl border border-gray-300
                    ...
                    <button type="button" onclick="togglePassword()" class="absolute right-4 top-1/2 -translate-y-1/2
                       text-gray-500 hover:text-emerald-600 transition" aria-label="Toggle password">
                        ...
                        <svg id="eyeClosed" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 hidden" fill="none"
                         ...
                         a9.956 9.956 0 012.042-3.368" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6.223 6.223A9.957 9.957 0 0112 5
            ...
            <!-- BUTTON -->
            <button type="submit" class="w-full py-3 mt-2 rounded-xl font-semibold text-white
